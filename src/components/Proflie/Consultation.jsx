...
// Chat bar
import EmojiChat from '../../assets/EmojiChat.png'; // updated import
import FileChat from '../../assets/FileChat.png'; // updated import
            ...
            InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <IconButton edge="start" aria-label="Insert emoji" sx={{ ml: '18px' }}>
                      <img src={EmojiChat} alt="Emoji" style={{ width: '20px', height: '20px' }} />
                    </IconButton>
                  </InputAdornment>
                ),
                endAdornment: (
                  <InputAdornment position="end">
                    <IconButton edge="end" aria-label="Attach file" sx={{ mr: '16px' }}>
                      <img src={FileChat} alt="Attach file" style={{ width: '20px', height: '20px' }} />
                    </IconButton>
                  </InputAdornment>
                )
              }}
